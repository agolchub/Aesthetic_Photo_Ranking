...
srun python ./train_segmented.py --model_design 18 -o model18.1.train -b 5 --momentum 0.01 --loss mse -e 1000 -l 0.01 -d 0.01 --patience 50 -t ./databaserelease2/train.csv -v ./databaserelease2/val.csv --width 1024 --height 680 --outColumn 16
