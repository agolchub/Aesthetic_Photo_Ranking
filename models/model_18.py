...
def model_18(WIDTH, HEIGHT):
    ...
    add = tf.keras.layers.Add(dtype=tf.float16)([res1, res2, res3, res4])
    ...
    output = tf.keras.layers.Dense(5, kernel_initializer="he_uniform", activation="softmax", dtype=tf.float16)(flat)
