...
def model_23(WIDTH, HEIGHT):
    ...
    dense = tf.keras.layers.Dense(2048, kernel_initializer="he_uniform", activation="relu", dtype=tf.float16)(flat)
    dense = tf.keras.layers.Dense(1024, kernel_initializer="he_uniform", activation="relu", dtype=tf.float16)(dense)
    dense = tf.keras.layers.Dense(512, kernel_initializer="he_uniform", activation="relu", dtype=tf.float16)(dense)
    dense = tf.keras.layers.Dense(256, kernel_initializer="he_uniform", activation="relu", dtype=tf.float16)(dense)
    dense = tf.keras.layers.Dense(128, kernel_initializer="he_uniform", activation="relu", dtype=tf.float16)(dense)
    dense = tf.keras.layers.Dense(128, kernel_initializer="he_uniform", activation="relu", dtype=tf.float16)(dense)
    output = tf.keras.layers.Dense(1, kernel_initializer="he_uniform", activation="sigmoid", dtype=tf.float16)(dense)
