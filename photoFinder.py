import requests
response = requests.get("https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=34b062421be395f7de0912fe00a37193&per_page=500&format=json&nojsoncallback=1&tags=forest%2C+woods&media=photos&extras=count_faves&license=7,8,9,10")
